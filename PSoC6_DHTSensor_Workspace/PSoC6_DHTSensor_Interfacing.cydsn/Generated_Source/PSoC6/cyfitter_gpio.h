...
/* DHT_DATA */
#define DHT_DATA_0_DRIVEMODE CY_GPIO_DM_OD_DRIVESLOW
#define DHT_DATA_0_INBUF_ENABLED 1u
#define DHT_DATA_0_INIT_DRIVESTATE 1u
#define DHT_DATA_0_INIT_MUXSEL 0u
#define DHT_DATA_0_INPUT_SYNC 2u
#define DHT_DATA_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define DHT_DATA_0_NUM 6u
#define DHT_DATA_0_PORT GPIO_PRT5
#define DHT_DATA_0_SLEWRATE CY_GPIO_SLEW_FAST
#define DHT_DATA_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define DHT_DATA_DRIVEMODE CY_GPIO_DM_OD_DRIVESLOW
#define DHT_DATA_INBUF_ENABLED 1u
#define DHT_DATA_INIT_DRIVESTATE 1u
#define DHT_DATA_INIT_MUXSEL 0u
#define DHT_DATA_INPUT_SYNC 2u
#define DHT_DATA_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define DHT_DATA_NUM 6u
#define DHT_DATA_PORT GPIO_PRT5
#define DHT_DATA_SLEWRATE CY_GPIO_SLEW_FAST
#define DHT_DATA_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
